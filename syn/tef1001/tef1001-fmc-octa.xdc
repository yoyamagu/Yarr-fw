#la32_n
#la32_p
set_property PACKAGE_PIN L17 [get_ports {fe_clk_p[0]}]
set_property PACKAGE_PIN K18 [get_ports {fe_clk_n[0]}]
#la30_n
#la30_p
set_property PACKAGE_PIN K16 [get_ports {fe_clk_p[1]}]
set_property PACKAGE_PIN K17 [get_ports {fe_clk_n[1]}]
#la28_n
#la28_p
set_property PACKAGE_PIN L19 [get_ports {fe_clk_p[2]}]
set_property PACKAGE_PIN L20 [get_ports {fe_clk_n[2]}]
#la26_n
#la26_p
...
#la00_cc_n
#la00_cc_p
set_property PACKAGE_PIN N21 [get_ports {fe_clk_p[4]}]
set_property PACKAGE_PIN N22 [get_ports {fe_clk_n[4]}]
#la02_n
#la02_p
set_property PACKAGE_PIN U19 [get_ports {fe_clk_p[5]}]
set_property PACKAGE_PIN U20 [get_ports {fe_clk_n[5]}]
#la04_n
#la04_p
set_property PACKAGE_PIN R16 [get_ports {fe_clk_p[6]}]
set_property PACKAGE_PIN R17 [get_ports {fe_clk_n[6]}]
#la06_n
#la06_p
set_property PACKAGE_PIN T22 [get_ports {fe_clk_p[7]}]
set_property PACKAGE_PIN T23 [get_ports {fe_clk_n[7]}]
...
#la31_n
#la31_p
set_property PACKAGE_PIN J15 [get_ports {fe_cmd_p[1]}]
set_property PACKAGE_PIN J16 [get_ports {fe_cmd_n[1]}]
#la29_n
#la29_p
set_property PACKAGE_PIN J18 [get_ports {fe_cmd_p[2]}]
set_property PACKAGE_PIN J19 [get_ports {fe_cmd_n[2]}]
#la27_n
#la27_p
set_property PACKAGE_PIN G15 [get_ports {fe_cmd_p[3]}]
set_property PACKAGE_PIN F15 [get_ports {fe_cmd_n[3]}]
#la01_cc_n
#la01_cc_p
set_property PACKAGE_PIN R21 [get_ports {fe_cmd_p[4]}]
set_property PACKAGE_PIN P21 [get_ports {fe_cmd_n[4]}]
#la03_n
#la03_p
set_property PACKAGE_PIN T20 [get_ports {fe_cmd_p[5]}]
set_property PACKAGE_PIN R20 [get_ports {fe_cmd_n[5]}]
#la05_n
#la05_p
set_property PACKAGE_PIN T24 [get_ports {fe_cmd_p[6]}]
set_property PACKAGE_PIN T25 [get_ports {fe_cmd_n[6]}]
#la07_n
#la07_p
...
#la21_n
#la21_p
set_property PACKAGE_PIN C16 [get_ports {fe_data_p[4]}]
set_property PACKAGE_PIN B16 [get_ports {fe_data_n[4]}]
#la22_n
#la22_p
...
#la08_n
#la08_p
set_property PACKAGE_PIN P24 [get_ports {fe_data_p[6]}]
set_property PACKAGE_PIN N24 [get_ports {fe_data_n[6]}]
#la09_n
#la09_p
...
#fake port
#la03_p (la20_n)
set_property PACKAGE_PIN G20 [get_ports {pwdn_l[0]}]
#la03_n (la16_n)
set_property PACKAGE_PIN M19 [get_ports {pwdn_l[1]}]
#la14_p
set_property PACKAGE_PIN U17 [get_ports {pwdn_l[2]}]

#la12_n
#set_property PACKAGE_PIN P18 [get_ports {io[0]}]
#la14_n
#set_property PACKAGE_PIN T17 [get_ports {io[1]}]
#la16_n
#set_property PACKAGE_PIN M19 [get_ports {io[2]}]
...
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[4]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[5]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[6]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_n[7]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[2]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[3]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[4]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[5]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[6]}]
set_property IOSTANDARD LVDS_25 [get_ports {fe_data_p[7]}]
